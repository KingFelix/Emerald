...
In earlier posts, I outlined how the developer persona relates to sales and marketing (https://jesse-williams.com/developer-buying-journey), how open source impacts developer marketing (https://jesse-williams.com/opensource-developer-buying-journey), and the developer budget debate (https://jesse-williams.com/developers-and-bant). If you haven’t read those posts, I would suggest that you take a moment and read through them. In this post I’ll make the assumption that we share a basic understanding of developer marketing, the developer persona, and the open source business model. 
